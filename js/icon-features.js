    ...
    <div class="icon-modal-content">
      ...
      <div class="icon-modal-body">
        ...
        <div class="share-buttons-grid">
          ...
          <button class="share-btn linkedin" onclick="shareOnLinkedIn('${shareUrl}', '${encodeURIComponent(shareTitle)}')">
            <span class="share-icon">💼</span>
            <span>LinkedIn</span>
          </button>
          <button class="share-btn telegram" onclick="shareOnTelegram('${shareUrl}', '${encodeURIComponent(shareText)}')">
            <span class="share-icon">✈️</span>
            <span>Telegram</span>
          </button>
          <button class="share-btn email" onclick="shareViaEmail('${shareUrl}', '${encodeURIComponent(shareTitle)}', '${encodeURIComponent(shareText)}')">
            <span class="share-icon">📧</span>
            <span>Email</span>
          </button>
